    ...
    <div id="main-container" className="relative min-h-screen bg-black inter">
      {isSmallScreen ? (
        <div className="flex flex-col items-center justify-center min-h-screen text-center text-white">
          <p className="text-xl">This site is intended for larger screens.</p>
          <p className="text-xl">
            In the meantime, feel free to check out my 
            <a href="https://www.linkedin.com/in/chasekellogg/" target="_blank" rel="noopener noreferrer" className="ml-1 mr-1 text-purple-500 hover:text-purple-800">LinkedIn</a>
            or
            <a href="https://github.com/chasekellogg12" target="_blank" rel="noopener noreferrer" className="ml-1 text-purple-500 hover:text-purple-800">GitHub</a>.
          </p>
          <p className="text-xl">- Chase Kellogg</p>
        </div>
      ) : (
        <>
          <Navbar></Navbar>
            ...
            <section id="portfolio" className="relative z-40 flex items-center justify-center min-h-screen mt-24 text-center bg-transparent scroll-m-24">
              <div className='flex-col items-center w-screen space-y-8'>
                ...
                <div className='flex flex-col items-center justify-center w-full space-y-8'>
                  ...
                  <ProjectCard title="CHIP-8 Emulator" image={chip8} technologies={["C", "SDL2", "Git"]} codeLink="https://github.com/chasekellogg12/CHIP8-in-C" desc={["Developed a fully functional CHIP-8 emulator in C, handling all opcodes and ensuring accurate representation of original game behavior", "Implemented display rendering using SDL2, enabling pixel-perfect graphics scaling and smooth performance for a 64x32 display", "Created a user-friendly interface to load and run CHIP-8 ROMs, allowing the emulator to be easily operated from the command line with custom ROMs", "Applied in-depth knowledge of computer architecture and low-level programming, leveraging college coursework and personal interest to replicate a classic computing system"]} />
